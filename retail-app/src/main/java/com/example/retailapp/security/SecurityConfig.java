    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors(Customizer.withDefaults()).authorizeHttpRequests(configurer ->
                configurer
                        ...
                        .requestMatchers(HttpMethod.PUT, "/store/products/{id}/name/{name}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/store/products/{id}/price/{amount}").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/store/products/{id}/category/{category}").permitAll()
                        //request matchers for orders
                        .requestMatchers(HttpMethod.GET, "/orders").permitAll()
                        .requestMatchers(HttpMethod.POST, "/orders").permitAll()
                        .requestMatchers(HttpMethod.POST, "/orders/files").permitAll()
