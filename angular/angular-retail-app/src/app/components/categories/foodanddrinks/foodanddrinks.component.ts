...
@Component({
  selector: 'app-foodanddrinks',
  templateUrl: './foodanddrinks.component.html',
  styleUrls: ['./foodanddrinks.component.css']
})
export class FoodanddrinksComponent implements OnInit {
  ...
  retrieveProducts(): void{
    this.productService.getAllProducts().subscribe((products) => {
      this.products = products.filter((a) => a.category == "Food and Drinks").sort((a,b) => (a.name > b.name ? 1 : -1));
    })
  }
...
@Component({
  selector: 'fnd-add-to-cart-dialog',
  templateUrl: 'fnd-add-to-cart-dialog.html',
  standalone: true,
  imports: [MatDialogModule, MatFormFieldModule, MatInputModule, FormsModule, MatButtonModule, MatSelectModule],
})
export class FoodandDrinksAddToCartDialog {
  constructor(
    public dialogRef: MatDialogRef<FoodanddrinksComponent>,
...
@Component({
  selector: 'fnd-success-add-cart-dialog',
  templateUrl: 'fnd-success-add-cart-dialog.html',
  standalone: true,
