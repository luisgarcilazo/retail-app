...
export class ToysComponent implements OnInit {
  ...
  addToCart(product: Product): void{
    ...
    const dialogRef = this.dialog.open(ToysAddToCartDialog, {
      ...
      if (result != undefined){
        ...
        if(cartStr == null){
          ...
          if(hasEnoughStock == true){
            const dialogRef2 = this.dialog.open(ToysSuccessAddCartDialog);
          } else {
            const dialogRef2 = this.dialog.open(NotEnoughStockDialog);
          }
...
@Component({
  selector: 'toys-add-to-cart-dialog',
  templateUrl: 'toys-add-to-cart-dialog.html',
  standalone: true,
  imports: [MatDialogModule, MatFormFieldModule, MatInputModule, FormsModule, MatButtonModule, MatSelectModule],
})
export class ToysAddToCartDialog {
  constructor(
    public dialogRef: MatDialogRef<ToysComponent>,
...
@Component({
  selector: 'toys-success-add-cart-dialog',
  templateUrl: 'toys-success-add-cart-dialog.html',
  standalone: true,
  imports: [MatDialogModule, MatButtonModule],
})
export class ToysSuccessAddCartDialog {}

@Component({
  selector: 'toys-not-enough-stock-dialog.',
