...
export class ElectronicsComponent implements OnInit {
  ...
  addToCart(product: Product): void{
    ...
    const dialogRef = this.dialog.open(ElectronicsAddToCartDialog, {
      ...
      if (result != undefined){
        ...
        if(cartStr == null){
          ...
          if(hasEnoughStock == true){
            const dialogRef2 = this.dialog.open(ElectronicsSuccessAddCartDialog);
          } else {
            const dialogRef2 = this.dialog.open(NotEnoughStockDialog);
          }
...
@Component({
  selector: 'electronics-add-to-cart-dialog',
  templateUrl: 'electronics-add-to-cart-dialog.html',
  standalone: true,
  imports: [MatDialogModule, MatFormFieldModule, MatInputModule, FormsModule, MatButtonModule, MatSelectModule],
})
export class ElectronicsAddToCartDialog {
  constructor(
    public dialogRef: MatDialogRef<ElectronicsComponent>,
...
@Component({
  selector: 'electronics-success-add-cart-dialog',
  templateUrl: 'electronics-success-add-cart-dialog.html',
  standalone: true,
  imports: [MatDialogModule, MatButtonModule],
})
export class ElectronicsSuccessAddCartDialog {}

@Component({
  selector: 'electronics-not-enough-stock-dialog.',
